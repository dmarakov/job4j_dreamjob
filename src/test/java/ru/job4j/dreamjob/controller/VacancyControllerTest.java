...
public class VacancyControllerTest {
    ...
    @Test
    public void whenRequestVacancyByIdThenGetVacancyPage() {
        var vacancy1 = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        ...
        assertThat(actualVacancies).isEqualTo(vacancy1);
    }

    @Test
    public void whenUpdateVacancyThenGetUpdatedVacancy() throws IOException {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    public void whenDeleteVacancyByIdThenRedirectToVacanciesPage() {
        ...
        var model = new ConcurrentModel();
        var view = vacancyController.delete(model, vacancy1.getId());
